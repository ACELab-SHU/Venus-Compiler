...
void Verifier::visitCallBase(CallBase &Call) {
  ...
  auto VerifyTypeAlign = [&](Type *Ty, const Twine &Message) {
    ...
    Align MaxAlign(ParamMaxAlignment);
    // Bypass this abi align check. The intrinsic will be splatted anyway.
    bool isVenusIntrinsic = (Call.getIntrinsicID() >= Intrinsic::venus_add_ivv) &&
                            (Call.getIntrinsicID() <= Intrinsic::venus_xor_ivx);
    Check(((ABIAlign <= MaxAlign) && !isVenusIntrinsic) || isVenusIntrinsic,
