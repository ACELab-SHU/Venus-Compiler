...
RISCVTargetLowering::RISCVTargetLowering(const TargetMachine &TM,
  ...
  if(Subtarget.hasExtVenus()) {
    addRegisterClass(MVT::v32i8, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v64i8, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v128i8, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v256i8, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v512i8, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v1024i8, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v16i16, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v32i16, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v64i16, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v128i16, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v256i16, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v512i16, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v8i32, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v16i32, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v32i32, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v64i32, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v128i32, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v256i32, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v4i64, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v8i64, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v16i64, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v32i64, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v64i64, &RISCV::VNSRRegClass);
    addRegisterClass(MVT::v128i64, &RISCV::VNSRRegClass);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v32i8, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v64i8, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v128i8, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v256i8, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v512i8, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v1024i8, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v16i16, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v32i16, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v64i16, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v128i16, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v256i16, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v512i16, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v8i32, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v16i32, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v32i32, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v64i32, Custom);
    ...
    setOperationAction(ISD::BUILD_VECTOR, MVT::v16i64, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v32i64, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v64i64, Custom);
    setOperationAction(ISD::BUILD_VECTOR, MVT::v128i64, Custom);
  }
...
static bool useRVVForFixedLengthVectorVT(MVT VT,
  ...
  case MVT::i32:
    break;
  case MVT::i64:
    if (!Subtarget.hasVInstructionsI64() || !Subtarget.hasExtVenus())
      return false;
    break;
  case MVT::f16:
    if (!Subtarget.hasVInstructionsF16())
