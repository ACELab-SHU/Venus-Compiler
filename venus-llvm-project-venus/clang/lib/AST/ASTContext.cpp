...
llvm::cl::opt<bool> HasVenus("venus",
                             llvm::cl::desc("Enable Venus uarch features."));
...
#include "clang/Basic/RISCVVTypes.def"
  ...
  if (Target.hasVenusType()) {
    InitBuiltinType(VenusTy, BuiltinType::Venus);
  }
