...
public:
  ...
  unsigned GetVenusOperandImm(Expr *E, StringRef Info);
  llvm::Value *EmitRISCVVenusRangeExpr(unsigned BuiltinID, const CallExpr *E);
  llvm::Value *EmitRISCVVenusMnotExpr(unsigned BuiltinID, const CallExpr *E);
  llvm::Value *EmitRISCVVenusShuffleExpr(unsigned BuiltinID, const CallExpr *E);
  llvm::Value *EmitRISCVVenusVaddrExpr(unsigned BuiltinID, const CallExpr *E,
                                       unsigned ArgOffset);
  llvm::Value *EmitRISCVVenusRetExpr(unsigned BuiltinID, const CallExpr *E);
  llvm::Value *EmitRISCVVenusComplexExpr(unsigned BuiltinID, const CallExpr *E);
  llvm::Value *EmitRISCVVenusShuffleTestExpr(unsigned BuiltinID, const CallExpr *E);
  llvm::Value *EmitRISCVVenusBuiltinExpr(unsigned BuiltinID, const CallExpr *E);
