...
llvm::cl::opt<unsigned> VenusTileBaseAddr(
    "venus-tile-baseaddr",
    llvm::cl::desc("Specify the base address of a tile of the Venus architecture."),
    llvm::cl::value_desc("value"),
    llvm::cl::init(0x80000000)
);

llvm::cl::opt<unsigned> VenusCRBaseAddr(
    "venus-cr-baseaddr",
    llvm::cl::desc("Specify the base address of the control registers of the Venus architecture."),
    llvm::cl::value_desc("value"),
    llvm::cl::init(0x801ff000)
);

llvm::cl::opt<std::string> VenusTaskName(
    "venus-task-name",
    llvm::cl::desc("Specify a name of the task. This is for generating a hash."),
    llvm::cl::value_desc("taskname"),
    llvm::cl::init("")
);
}
